...
class GenderModel(nn.Module):
    ...
    def __init__(self, num_classes=2, checkpoint_path="weights/pretrained/gender_model.pt"):
        super().__init__()
    ...
    def get_gender(self, logits):
        predicted_gender = torch.argmax(logits, dim=1)
